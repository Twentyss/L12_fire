...
{
ShowMessage("Данная программа демонстрирует процесс горения шара. Вокруг горящего шара крутится кольцо. Для вращения камеры зажмите левую кнопку мыши и водите ей.");
}
//---------------------------------------------------------------------------

void __fastcall TForm1::About1Click(TObject *Sender)
{
ShowMessage("Данный проект был реализован с использованием движка GLScene.");
}
//---------------------------------------------------------------------------
